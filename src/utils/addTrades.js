...
import { useBrokerHeldentrader, useBrokerInteractiveBrokers, useBrokerMetaTrader5, useBrokerTdAmeritrade, useBrokerTradeStation, useBrokerTradeZero, useTradovate, useNinjaTrader, useRithmic, useFundTraders, useTastyTrade, useTopstepX, useGoatFunded } from './brokers.js'
...
export async function useImportTrades(param1, param2, param3, param0) {
    return new Promise(async (resolve, reject) => {
        ...
        let readAsTextArray = ["tradeZero", "template", "tdAmeritrade", "interactiveBrokers" , "tradovate", "ninjaTrader", "heldentrader", "rithmic", "fundTraders", "tastyTrade", "topstepX", "goatFunded"]
        ...
        ****************************/
         ...
         * GOATFUNDED
         ****************************/
        if (selectedBroker.value == "goatFunded") {
            console.log(" -> GoatFunded")
            await useGoatFunded(fileInput).catch(error => {
                importFileErrorFunction(error)
            })
        }
